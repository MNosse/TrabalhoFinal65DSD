...
public class ImagesInstances {
    ...
    public static Image SEND_BTN;
    public static Image SEND_CLICKED_BTN;
    ...
    static {
        try {
            ...
            SEND_BTN = ImageIO.read(Objects.requireNonNull(ImagesInstances.class.getResource("/images/send_btn.png")));
            SEND_CLICKED_BTN = ImageIO.read(Objects.requireNonNull(ImagesInstances.class.getResource("/images/send_clicked_btn.png")));
